...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('subscription_feature')) {
            ...
            $table->float('price'); // Price of this feature within this subscription
            $table->timestamps();

            $table->unique(['subscription_id', 'subscription_feature_id'], 'sub_feature_unique');
            });
        }
    }
