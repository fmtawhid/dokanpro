...
return [
    'permissions' => [
        ...
        'dashboard' => ['super admin', 'admin', 'store'],
        ...
        'landing.install' => ['super admin', 'admin'],
        'landing.store' => ['super admin', 'admin'],
        ...
        'category.trash' => ['admin'],
        'category.restore' => ['admin'],
        'category.forceDelete' => ['admin'],
        ...
        'supplier.trash' => ['admin'],
        'supplier.restore' => ['admin'],
        'supplier.forceDelete' => ['admin'],
        ...
        'customer.trash' => ['admin'],
        'customer.restore' => ['admin'],
        'customer.forceDelete' => ['admin'],
        ...
        'warehouse.trash' => ['admin'],
        'warehouse.restore' => ['admin'],
        'warehouse.forceDelete' => ['admin'],
        //Customer group
        'customer.group.index' => ['admin'],
        'customer.group.store' => ['admin'],
        'customer.group.update' => ['admin'],
        'customer.group.delete' => ['admin'],
        'customer.group.trash' => ['admin'],
        'customer.group.restore' => ['admin'],
        'customer.group.forceDelete' => ['admin'],
        //Brand route
        'brand.index' => ['super admin', 'admin', 'store'],
        'brand.store' => ['super admin', 'admin', 'store'],
        'brand.update' => ['super admin', 'admin', 'store'],
        'brand.delete' => ['super admin', 'admin', 'store'],
        'brand.trash' => ['super admin', 'admin', 'store'],
        'brand.restore' => ['super admin', 'admin', 'store'],
        'brand.forceDelete' => ['super admin', 'admin', 'store'],
        //Unit route
        'unit.index' => ['admin'],
        'unit.store' => ['admin'],
        'unit.update' => ['admin'],
